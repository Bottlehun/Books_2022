...
* ### 2.1 XHTML 설정
    ...
    ```html
    <!-- 도입영상 -->
    <div class="팝업이름-btn pop-btn" data-link="videoPopup" data-num="1" tabindex="1" title="팝업이름"></div>
        ...
        <div class="pop-wrap" style="display: none;">
            <div class="pop-container">
                ...
                <div class="pop-textArea-group input-btn-show">
                    <textarea id="textarea-1" maxlength="292" title="입력" place="내용을 입력하세요."></textarea>
                </div>
                <!-- 텍스트 입력박스 -->
...
* ### 5.2 CSS 설정
    ...
    .pop-wedo-group .cycle-cont {position: relative; margin-bottom: 20px;}
    .pop-wedo-group .img-box {border-radius: 10px; border: 1px solid #ddd; padding: 5px;}
    ```
...
* ### 7.2 CSS 설정
    ...
    ```css
    /*궁금해요 텍스트박스 높이*/
    .pop-wonder-group .pop-textArea textarea{height: 80px;}
    ```
