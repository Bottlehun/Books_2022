...
* ### 6.3 CSS 설정
    ```css
    .dragdrop-group{z-index: 10;}
    .drag-txt-box{
        position: relative; font-family: 'KoPubDotumM'; font-size: 20px; background-color: #fff4e1; border-radius: 20px; padding: 35px; text-align: center;
        margin-bottom: 35px;
    }
